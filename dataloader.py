...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, file_root='data/', transform=None):
        ...
        self.e_gts = [file_root + '/' + dataset + '/edge/' + x for x in self.file_list]
    ...
    def __getitem__(self, idx):
        ...
        if self.transform:
            [img, label,e_label] = self.transform(img, label,e_label)
