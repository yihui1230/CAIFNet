...
class MobileNetV2(nn.Module):
    def __init__(self, pretrained=None, num_classes=1000, width_mult=1.0):
        ...
        self.embed_dims = [24, 32, 96, 320]
        self.am_1 = MS_CAM(self.embed_dims[0])
        self.am_2 = MS_CAM(self.embed_dims[1])
        self.am_3 = MS_CAM(self.embed_dims[2])
        self.am_4 = MS_CAM(self.embed_dims[3])
    ...
    def forward(self, x1, x2):
        ...
        for idx, m in enumerate(self.features):
            ...
            if idx in [3, 6, 13, 17]:
                ...
                res_1.append(x1)
                res_2.append(x2)
                am_list_1.append(am1)
                am_list_2.append(am2)
                n = n + 1
        return res_1, res_2, am_list_1,am_list_2
